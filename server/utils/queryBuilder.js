...
export function buildMongoQuery(node) {
    ...
    // Keep this mapping explicit so future operators can be audited without hidden fallbacks.
    ...
    function parseNode(n) {
      ...
      // Parsing order is depth-first to preserve exact logical grouping from the visual rule builder.
